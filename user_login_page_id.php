...
<div class="container">    
  <div class="row">
    ...
    <div class="col-sm-4" id = "login_area"> 
		...
		<?php include 'user_new_account_create.php';?>
		<form action='user_login_page_psw.php' method = 'post'>
			<div class="form-group">
			  <label for="email">User ID:</label>
			  <input type="text" class="form-control" id="id" placeholder="Enter ID" name="user_id">
			</div>
